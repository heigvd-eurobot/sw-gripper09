...
#define IMIN (-IMAX)
// Regulateur PI g�n�rique
// @param y : Grandeur mesur�e
// @param w : Valeur de consigne
// @param kp : Gain proportionnel
// @param gi : Gain int�gral
// @param iaction : buffer int�gral (ne pas oublier d're-initialiser)
// @return Grandeur r�gl�e
...
// @param y_position : Grandeur de position mesur�e [1.15]
// @param w_position : Consigne de position [1.15]
// @param bldc : Structure de donn�es du moteur r�gl�
// @return Grandeur r�gl�e [1.15]
