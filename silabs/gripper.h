...
// registre d'état des différentes machines
   uint8    state_bg;
   uint8    state_bd;
   uint8    state_lt;
   uint8    state_bi;
...
#define  E_TIME_OUT     1 	// Temps prévu pour le mouvement dépassé
#define  E_OVR_CPL      2 	// Couple dépassé  
#define  E_MOVE         3 	// Erreur imprévue durant le mouvement  
#define  E_OBSTACLE     4 	// Un obstacle est devant le bras       
#define  E_NO_PAL       5  // Il n'y a plus de pallet dans le robot
#define  E_PARAM        6  // les paramètres passé a la fonction est sont faux
