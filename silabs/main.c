/*============================================================\
 ...
 ============================================================
   ...
   But:  Programme principale de la carte gripper, gestion des
...
void main()
{
   ...
   while(1)
   {
      while(pos_actu.manual_mode==0xA5)
      {
         ...
         while(timer_cpt<625);   // attend 625*40[us] == 25 [ms]
         timer_cpt=0;
      ...
      while(pos_actu.manual_mode!=0xA5)
      {
         ...
         State_machine_lt();
         State_machine_bi();
         while(timer_cpt<625);   // nombre de fois ou l'on attend 40[us] == 25 [ms]
         timer_cpt=0;
